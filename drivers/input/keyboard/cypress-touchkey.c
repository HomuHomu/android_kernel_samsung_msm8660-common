...
if(touchled_cmd_reversed) {
			...
			|| defined (CONFIG_USA_MODEL_SGH_T989) || defined (CONFIG_USA_MODEL_SGH_I727) ||  defined (CONFIG_JPN_MODEL_SC_05D)
			msleep(100);
#endif
	//		msleep(300);
			if(!touchkey_enable )
...
|| defined(CONFIG_JPN_MODEL_SC_03D) || defined(CONFIG_JPN_MODEL_SC_05D)
